...
class ScenarioProvider implements AgentProvider {
  ...
  constructor(private readonly options: { tasks?: number; validator?: Array<"pass" | "fail" | "blocked">; finalValidator?: "pass" | "fail"; developerBlocked?: boolean; noOp?: boolean; generated?: boolean; writeScratch?: boolean } = {}) {}
