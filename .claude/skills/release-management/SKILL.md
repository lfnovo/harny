...
See `RELEASE.md §Cheap validator patterns` — this section is architect-only guidance (audience rule from CLAUDE.md: skills are for downstream harny users; methodology for people working ON harny lives in RELEASE.md).
